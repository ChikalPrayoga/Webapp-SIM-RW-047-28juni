<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Edit Pengguna') }}: {{ $user->full_name }}
        </h2>
    </x-slot>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                <form action="{{ route('admin.users.update', $user) }}" method="POST" class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="full_name" id="full_name" value="{{ old('full_name', $user->full_name) }}" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                    ...
                    <div>
                        <label for="role_id" class="block text-sm font-medium text-gray-700">Role Sistem</label>
                    ...
                    <div class="border-t pt-6">
                        <h3 class="text-lg font-medium text-gray-900 mb-4">Ganti Password (Kosongkan jika tidak ingin mengubah)</h3>
                        <div class="space-y-4">
                            <div>
                    ...
                    <div class="flex justify-end gap-4 border-t pt-6">
                        <a href="{{ route('admin.users.index') }}" class="px-4 py-2 bg-gray-100 border border-gray-300 rounded-md font-medium text-gray-700 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
                            Batal
                        </a>

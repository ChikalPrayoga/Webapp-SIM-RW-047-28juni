        ...
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <form method="POST" action="{{ route('finances.iuran-types.store') }}" class="space-y-6">
                        @csrf
                        ...
                        <div>
                            ...
                            <x-text-input id="default_nominal" name="default_nominal" type="number" step="0.01" class="mt-1 block w-full" :value="old('default_nominal', '0.00')" required />
                        ...
                        <div>
                            ...
                            <select id="type" name="type" class="mt-1 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" required>
                                ...
                                <option value="SUKARELA" {{ old('type') == 'SUKARELA' ? 'selected' : '' }}>SUKARELA</option>
                            </select>
